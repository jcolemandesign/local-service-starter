...
The goal is to create a modular, reusable, visually polished system for local service business websites while keeping architecture, spacing, typography, and responsiveness consistent across projects.
...
Do not invent local type styles, spacing systems, or one-off layout patterns unless specifically requested.
