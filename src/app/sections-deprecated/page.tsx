...
export const metadata: Metadata = {
  title: "Deprecated Section Library",
  description:
    "Deprecated v2 section library retained for reference while v3 is current.",
};
      ...
      <section className="bg-service-ink py-16 text-white">
        <Container>
          ...
          <h1 className="mt-4 text-fluid-heading font-semibold leading-heading">
            Deprecated Section Library
          </h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-white/75">
            Previous v2 section library retained for reference. Use /sections
            for the current seven-column system.
          </p>
        </Container>
      </section>
