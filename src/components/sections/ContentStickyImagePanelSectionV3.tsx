      ...
      <SevenColumnGrid className="relative section-min-sticky items-start max-md:section-min-screen">
        ...
        >
          <div className="sticky top-[var(--site-grid-inset-block)] max-md:static">
            <article className="content-padding fluid-type-frame radius-medium card-min-medium flex max-h-[calc(100svh-(var(--site-grid-inset-block)*2))] w-full flex-col justify-between overflow-auto border border-service-border bg-surface-raised shadow-service max-md:card-min-tall">
              <div>
