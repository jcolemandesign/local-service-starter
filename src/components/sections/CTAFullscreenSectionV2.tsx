...
export function CTAFullscreenSectionV2({
  ...
  return (
    <section className="relative grid min-h-[80svh] overflow-hidden bg-service-ink py-16 text-white max-md:py-12">
      ...
      <div className="container-site relative z-10 grid h-full grid-rows-[1fr_auto_1fr] items-center">
        <div />

        <div className={cx("fluid-type-frame", "mx-auto w-full max-w-6xl text-center")}>
          <p className={cx("type-label", "mb-5 text-white/75")}>
            {eyebrow}
          </p>
          <h2
            className={cx(
