  ...
  return (
    <section className="bg-bg-page">
      <LayoutGrid className="section-min-none items-center" columns={14} padding="med">
        ...
        >
          <article className="grid gap-4 rounded-[var(--radius-surface-token)] border border-service-border bg-service-surface p-8 text-service-ink shadow-service max-md:p-6">
            <h3 className="type-heading-sm text-service-ink">{ctaTitle}</h3>
