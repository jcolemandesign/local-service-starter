...
type ContentSplitFullImageSectionLibraryDemoProps = Omit<
  ComponentProps<typeof ContentSplitFullImageSectionV3>,
  "variant"
>;
...
export function ContentSplitFullImageSectionLibraryDemo(
  props: ContentSplitFullImageSectionLibraryDemoProps,
) {
  const [variant, setVariant] = useState<ContentSplitFullImageVariant>(
  ...
  return (
    <div>
      ...
      <ContentSplitFullImageSectionV3 {...props} variant={variant} />
    </div>
  );
}
